...
import net.media.training.live.srp.GetEmployeeDetailsInHTML;
...
public class EmployeeTest {
    ...
    public void shouldReturnEmployeeInfo() {
        ...
        GetEmployeeDetailsInHTML getEmployeeDetailsInHTML = new GetEmployeeDetailsInHTML();
        String employeeInfo = getEmployeeDetailsInHTML.get(employee);
